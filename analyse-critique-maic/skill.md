...
- **Ne jamais présenter le seuil de SMD < 0,10 comme une norme réglementaire** : c'est un repère conventionnel utile à la lecture, pas une exigence formelle des guides de référence cités.
