...
Il s'agit d'un standard ouvert disponible maintenant sur presque toutes les IA.
...
>Il est important d'analyser le contenu des skills avant de les installer pour écarter la possibilité de skill malveillante (par injection de prompt). Les IA font une analyse avant de faire l'installation mais rien ne vaut une inspection visuelle du contenu de la skill avant son installation.
