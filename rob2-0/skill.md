...
- Apply the RoB 2 tool **per outcome**, not globally per study. If multiple outcomes are assessed, produce a separate object for each.
...
### Signalling question 1.2 - Was the allocation sequence concealed until participants were enrolled and assigned to interventions?
...
### Signalling question 1.3 - Did baseline differences between intervention groups suggest a problem with the randomization process?
...
Question 2.1 to 2.5: part 1
Question 2.6 to 2.7: part 2
Algorithm for suggested judgement of risk of bias due to deviations from the intended interventions:
- Low rish if low risk at part 1 et part 2
- High risk if either high risk at part 1 or part 2
- Some concerns otherwise
- No information if no information at part 1 or part 2

### Signalling question 2.1 - Were participants and personnel blinded to the intervention?
...
### Signalling question 2.2 - Were there deviations from the intended intervention that arose because of the trial context?
...
### Signalling question 2.3 If yes, were these deviations likely to have affected the outcome?
If Y/PY/NI to 2.1 or 2.2:
...
### Signalling question 2.4 Was an appropriate analysis used to estimate the effect of assignment to intervention?
If Y/PY to 2.3:
...
### Signalling question 2.5 Was there potential for substantial non-adherence to the assigned intervention that could have affected outcome?
...
### Signalling question 2.6 Was an appropriate analysis used to estimate the effect of assignment to intervention?
...
### Signalling question 2.7 Was there potential for a substantial impact (on the result) of the failure to analyse participants in the group to which they were randomized?
If N/PN/NI to 2.6:
...
### Signalling question 3.1 Were outcome data available for all, or nearly all, randomized participants?
...
### Signalling question 3.2 If not, is there evidence that the result was not biased by missing data?
...
### Signalling question 3.3 Could missingness in the outcome depend on its true value?
If N/PN to 3.2: 
...
### Signalling question 3.4 If yes, Is it likely that missingness in the outcome depended on its true value?
...
### Signalling question 4.1 Was the method of measuring the outcome inappropriate?
...
### Signalling question 4.2 Was the measurement method likely to differ between intervention groups?
...
### Signalling question 4.3 Were outcome assessors blinded to the intervention?
If N/PN/NI to 4.1 and 4.2:
...
### Signalling question 4.4 If not, could knowledge of the intervention have influenced the outcome assessment?
If Y/PY/NI to 4.3:
...
### Signalling question 4.5 Is it likely that assessment of the outcome was influenced by knowledge of intervention received?
...
### Signalling question 5.1 Were the data that produced this result analysed in accordance with a pre-specified analysis plan that was finalized before unblinded outcome data were available for analysis?
...
### Signalling question 5.2 Was the numerical result selected from multiple eligible outcome measurements?
...
### Signalling question 5.3 Was the numerical result selected from multiple eligible analyses of the data?
...
| Domains | Overall judgment |
|---|---|
| All Low | "Low" |
| At least one Some concerns, none High | "Some concerns" |
| At least one High, or multiple Some concerns substantially reducing confidence | "High" |

---

## Difference by outcome

if the risk of bias is different from this global evaluation for some outcomes, list for each outcome that scores differently the specific overall risk of bias for these outcomes with justification.
